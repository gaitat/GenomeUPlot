...
svgIntersections.intersect.plugin( require('svg-intersections/lib/functions/bezier') );

window.svgIntersections = svgIntersections;

},{"svg-intersections":9,"svg-intersections/lib/functions/bezier":12}],2:[function(require,module,exports){
// expose classes
...
},{"./lib/Matrix2D":3,"./lib/Point2D":4,"./lib/Vector2D":5}],3:[function(require,module,exports){
/**
 *   Matrix2D.js
 *
...
},{"./lib/Polynomial":7,"./lib/SqrtPolynomial":8}],7:[function(require,module,exports){
/**
 *
 *   Polynomial.js
 *
...
Polynomial.newton_secant_bisection = function (x0, f, df, max_iterations, min, max) {
    ...
    if (isBounded) {
        ...
        y_atmin = f(min);
        y_atmax = f(max);
        // TODO: commented out since it was raising exceptions while perhaps it shouldn't
...
},{"./Polynomial":7}],9:[function(require,module,exports){
// expose module classes

exports.intersect = require('./lib/intersect');
exports.shape = require('./lib/IntersectionParams').newShape;
},{"./lib/IntersectionParams":11,"./lib/intersect":13}],10:[function(require,module,exports){
/**
 *  Intersection
 */
...
},{"kld-affine":2}],12:[function(require,module,exports){
...
module.exports.Utils = { removeMultipleRootsIn01: removeMultipleRootsIn01 };
...
},{"../Intersection":10,"kld-affine":2,"kld-polynomial":6}],13:[function(require,module,exports){
/**
 *
 *  Intersection.js
 *
...
},{"./Intersection":10,"./IntersectionParams":11,"kld-affine":2,"kld-polynomial":6}]},{},[1]);
